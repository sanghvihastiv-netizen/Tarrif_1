    ...
    <section className="relative pt-32 pb-20 md:pt-40 md:pb-28 overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <div className="inline-flex items-center gap-2 bg-white/5 backdrop-blur-sm rounded-full px-3 py-1 mb-6 border border-white/10">
          ...
          <span className="text-xs text-gray-300">Cost intelligence</span>
        </div>
        ...
        <p className="text-lg md:text-xl text-gray-400 max-w-3xl mx-auto mb-10">
          Model freight, insurance, duties, taxes, and port charges across shipping modes.
          Use the calculator, validate tax data, and save only the calculations you want to keep.
        </p>
        ...
        <div className="flex flex-wrap justify-center gap-8 md:gap-12 pt-8 border-t border-white/10">
          <div className="text-center">
            ...
            <div className="text-xs text-gray-500">Calculation steps</div>
          </div>
          <div className="text-center">
            <div className="text-2xl md:text-3xl font-bold text-amber-400">3</div>
            <div className="text-xs text-gray-500">Shipping modes</div>
          </div>
          <div className="text-center">
            <div className="text-2xl md:text-3xl font-bold text-amber-400">AI</div>
            <div className="text-xs text-gray-500">Tax extraction</div>
          </div>
        </div>
      </div>
    </section>
